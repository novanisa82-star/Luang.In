        ...
        <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
            ...
            <div>
                <div class="flex items-center gap-2 mb-1.5">
                    ...
                    <span class="text-[11px] font-extrabold tracking-wider text-gray-500 uppercase">
                        {{ $isRiwayat ? 'RIWAYAT PELAMAR MASUK' : 'MANAJEMEN PELAMAR MASUK' }} • ID REQ: #KSL-{{ str_pad($selectedLowongan->id ?? '8842', 4, '0', STR_PAD_LEFT) }}
                    </span>
                </div>

                <h1 class="text-2xl sm:text-3xl font-extrabold text-gray-900 tracking-tight flex items-center gap-3">
                    <span>Pelamar — {{ $selectedLowongan->judul ?? 'Tenaga Angkut Gudang Harian' }}</span>
                </h1>
            ...
            <div class="flex flex-wrap items-center gap-2.5 self-start lg:self-center">
                ...
                <div class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-gray-50 border border-gray-200 text-xs font-semibold text-gray-600">
                    <span>{{ $selectedLowongan->durasi ?? 'Shift Pagi (07.00 - 15.00)' }}</span>
                </div>
            ...
            <div class="divide-y divide-gray-100">
                ...
                @empty
                    <div class="p-12 text-center text-gray-400">
                        ...
                        <p class="text-sm font-semibold text-gray-600 mt-2">Belum ada pelamar yang cocok untuk filter ini.</p>
                        <p class="text-xs text-gray-400 mt-1">Coba sesuaikan filter status atau pilih lowongan lain.</p>
                    </div>
                @endforelse
            </div>
